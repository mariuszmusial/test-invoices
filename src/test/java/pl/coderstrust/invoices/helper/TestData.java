...
public class TestData {
  ...
  public static Invoice sampleInvoice() {
    return sampleInvoice(11L);
  }

  public static Invoice sampleInvoice(Long id) {
  ...
  public static List<InvoiceEntry> sampleInvoiceEntries() {
  ...
  public static Company sampleCompany2() {
